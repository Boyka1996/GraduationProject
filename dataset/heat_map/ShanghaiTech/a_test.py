...
def parse_args():
    ...
    parser.add_argument(
        ...
        dest='npy_path',
        help='',
        default='/home/chase/datasets/crowd_counting/ShanghaiTech/part_A_final/test_data/npy_0.25',
        # default=None,
        type=str
    ),
    parser.add_argument(
        ...
        dest='data_set_info',
        help='',
        default='/home/chase/datasets/crowd_counting/ShanghaiTech/part_A_final/'
                'test_data/ShanghaiTechA_test_info_0.25.json',
        # default=None,
        type=str
    )
