...
class MCNNModel(nn.Module):
    def __init__(self):
        ...
        self.brunch1 = nn.Sequential(
            nn.Conv2d(in_channels=3, out_channels=16, kernel_size=9, padding=4, padding_mode='zeros'),
            nn.MaxPool2d(2),
            nn.Conv2d(in_channels=16, out_channels=32, kernel_size=7, padding=3, padding_mode='zeros'),
            nn.MaxPool2d(2),
            nn.Conv2d(in_channels=32, out_channels=16, kernel_size=7, padding=3, padding_mode='zeros'),
            nn.Conv2d(in_channels=16, out_channels=8, kernel_size=7, padding=3, padding_mode='zeros')
        )

        self.brunch2 = nn.Sequential(
            nn.Conv2d(in_channels=3, out_channels=20, kernel_size=7, padding=3, padding_mode='zeros'),
            nn.MaxPool2d(2),
            nn.Conv2d(in_channels=20, out_channels=40, kernel_size=5, padding=2, padding_mode='zeros'),
            nn.MaxPool2d(2),
            nn.Conv2d(in_channels=40, out_channels=20, kernel_size=5, padding=2, padding_mode='zeros'),
            nn.Conv2d(in_channels=20, out_channels=10, kernel_size=5, padding=2, padding_mode='zeros')
        )

        self.brunch3 = nn.Sequential(
            nn.Conv2d(in_channels=3, out_channels=24, kernel_size=5, padding=2, padding_mode='zeros'),
            nn.MaxPool2d(2),
